...
function sendAjaxTransferRequest(a, privkey, message, recipientAddr){
	var amount = parseInt(a * 1000000, 10);
	var message = {payload:message,type:1};
	var due = 60;
	var mosaics = null;
	var mosaicsFee = null;
	...
	var kp = KeyPair.create(fixPrivateKey(privkey));
	...
	return $.ajax({
		url: SERVER_ROOT_URL + "/transaction/announce" ,
		type: 'POST',
